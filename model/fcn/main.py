...
def train(net, inputs_list, num_epochs, params=None, lr=None):
    for epoch in range(num_epochs):
        ...
        if epoch == 30:
            torch.save(net.model.state_dict(), os.path.join("../models/", "fcn_"+str(epoch)+".pth"))
            torch.save(net.optimizer.state_dict(), os.path.join("../models/", "fcn_opt_"+str(epoch)+".pth"))
...
if __name__ == '__main__':
    ...
    model = Model(num_inputs, num_hiddens, num_outputs, batch_size)
    train(model, inputs_list, num_epochs)
